    ...
    public static class DataAccessData
    {
       ...
       if (id == 0)
        ...
        public static Person  GetUserDetails(int UId)
        {
            ...
            System.Data.SqlClient.SqlDataReader data = ac.ExecuteDataTableProcedure("GetUserProfile", variables, values, ac);
        ...
        public static List<Cattle> GetUserAnimals( int UId,Person person)
        {
            ...
            System.Data.SqlClient.SqlDataReader data = ac.ExecuteDataTableProcedure("GetAllAnimals", variables, values, ac);
...
//@ParentGender varchar(100)
            ...
            //get data from  database 
            System.Data.SqlClient.SqlDataReader data = ac.ExecuteDataTableProcedure("GetAnimalOffspring", variables, values, ac);
        ...
        { 
            ...
            //get data from  database 
            System.Data.SqlClient.SqlDataReader data  = ac.ExecuteDataTableProcedure("GetSpecAnimalHsWeights", variables, values, ac);
        ...
        public static List<Cattle> GetUserAnimals(int UId ,int AnimalID)
        {
            ...
            //get data from  database 
            System.Data.SqlClient.SqlDataReader data  = ac.ExecuteDataTableProcedure("GetOneAnimal", variables, values, ac);
